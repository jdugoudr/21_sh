...
# define AFTER_ANOR		(NAME_TOK | WORD_TOK | SUB_SHELL | G_QUOT)
# define AFTER_NAME		(ASSIGN_TOK)
# define AFTER_PIPE		(WORD_TOK | SUB_SHELL | G_QUOT | NAME_TOK)
# define AFTER_SEMI		(WORD_TOK|NAME_TOK|SUB_SHELL|G_QUOT|TYPE_END|SEMI_COL)
